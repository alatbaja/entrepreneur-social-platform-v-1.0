...
```bash
git remote add encore encore://entrepreneur-social-platform-6m32
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/entrepreneur-social-platform-6m32/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/entrepreneur-social-platform-6m32/settings/integrations/github)
